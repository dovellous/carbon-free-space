...
class UsersBaseController extends \Acme\Core\Bases\AcmeController
{
    ...
    /**
     * Initialize the request for the users
     *
     * @param class $usersRequest
     */
    public $usersRequest;

    /**
     * Initialize the response for the users
     *
     * @param class $usersResponse
     */
    ...
    public function initController(\CodeIgniter\HTTP\RequestInterface $request, \CodeIgniter\HTTP\ResponseInterface $response, \Psr\Log\LoggerInterface $logger)
    {
        ...
        $this->usersConfig->systemConfig["i18n.browser.negotiated"] = $this->language;
        // Get the user specified language
        $this->usersConfig->systemConfig["i18n.user.defined"] = $this->locale;
        // Get the system language
        $this->usersConfig->systemConfig["i18n.system.defined"] = $this->locale;
        // Get the system language

        $this->usersConfig->config["namespace.path"] = ROOTPATH . "Acme\Core\System\Modules\Auth\Users\\";
        ...
        $isOperationAllowed = $this->usersLibrary->isOperationAllowed($userSessionData, $request,  $this->usersConfig->config["system"], $this->moduleName, $this->componentName, __METHOD__, __NAMESPACE__, __CLASS__);
        ...
        if($isOperationAllowed){
            ...
            $this->usersConfig->config["user"] = $userSessionData;

            // Assign the menu based on the user type
            $this->usersConfig->config["menu"] = $this->usersLibrary->getMenu($this->usersRequest, $this->moduleName, $this->componentName, __METHOD__, __NAMESPACE__, __CLASS__);
