...
/**
 * Load the theme default header to before loading Dashboard
 *
 * @author      ThemeXenia
...
if (!is_file(ROOTPATH . $viewPath . '.php')) {
    ...
    $contentAfterHeadOpen[] = view($hooksPathDashboard . "DashboardHeadAfterOpen");
    ...
    $contentCustomStyles[] = view($hooksPathDashboard . "DashboardCustomStyles");
    ...
    if (isset($config)) {
        ...
        if (array_key_exists("customHooks", $config)) {
            ...
            if (is_array($config["customHooks"])) {
                ...
                // Check to see if the hook is applicable
                // by verifying the looking at the hook name
                if (array_key_exists("DashboardCustomStyles", $config["customHooks"])) {
                    // Add hook view content
                    $contentCustomStyles[] = $config["customHooks"]["DashboardCustomStyles"];
    ...
    $contentBeforeHeadClose[] = view($hooksPathDashboard . "DashboardHeadBeforeClose");
    ...
    if (isset($config)) {
        ...
        if (array_key_exists("customHooks", $config)) {
            ...
            if (is_array($config["customHooks"])) {
                ...
                // Check to see if the hook is applicable
                // by verifying the looking at the hook name
                if (array_key_exists("DashboardHeadBeforeClose", $config["customHooks"])) {
                    // Add hook view content
                    $contentBeforeHeadClose[] = $config["customHooks"]["DashboardHeadBeforeClose"];
    ...
    $contentAfterBodyOpen[] = view($hooksPathDashboard . "DashboardBodyAfterOpen");
    ...
    if (isset($config)) {
        ...
        if (array_key_exists("customHooks", $config)) {
            ...
            if (is_array($config["customHooks"])) {
                ...
                // Check to see if the hook is applicable
                // by verifying the looking at the hook name
                if (array_key_exists("DashboardBodyAfterOpen", $config["customHooks"])) {
                    // Add hook view content
                    $contentAfterBodyOpen[] = $config["customHooks"]["DashboardBodyAfterOpen"];
